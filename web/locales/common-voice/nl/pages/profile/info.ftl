...
why-profile-text = Door wat informatie over uzelf te geven, zijn de door u bij ons ingediende audiogegevens nuttiger voor spraakherkenningsengines die deze gegevens gebruiken om hun nauwkeurigheid te verbeteren.
dashboard = Dashboard
...
accept-privacy = Ik ga akkoord met hoe u met deze gegevens omgaat, zoals uitgelegd in het <privacyLink>Privacybeleid</privacyLink>.
...
help-accent-explanation = Uw accent kan worden gevormd door waar u hebt gewoond, welke andere talen u spreekt en tal van andere factoren. U kunt hier alle informatie delen die u relevant vindt.
