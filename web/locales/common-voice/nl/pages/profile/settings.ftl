...
add-language = Variant toevoegen
change-email-setings = Wijzig uw e-mailadres via Instellingen onder Aanmeldingsidentiteit
email-change-information = Stuur ons een e-mailbericht naar <emailFragment>commonvoice@mozilla.com</emailFragment> om uw e-mailadres te wijzigen of te bewerken
