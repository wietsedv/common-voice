...
background-noise-explanation = U moet elk woord van de opname kunnen horen. We willen dat spraakherkenningssystemen een verscheidenheid aan achtergrondgeluiden kunnen verwerken, en zelfs relatief harde geluiden of zachte achtergrondmuziek kunnen worden geaccepteerd, op voorwaarde dat ze u er niet van weerhouden om de hele tekst te horen. Gekraak of ‘wegvallen’, waardoor u de tekst niet hoort, betekent dat u het fragment moet weigeren.
...
example-questions-explanation-2 = Als u een reeks vragen voor opname wilt indienen, kunt u <githubLink>dit doen via onze GitHub</githubLink> of uw lijst e-mailen naar <emailFragment>wietse.de.vries@rug.nl.</emailFragment>
