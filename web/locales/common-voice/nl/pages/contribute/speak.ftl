...
record-instruction = { $actionType } <recordIcon></recordIcon> en lees de zin vervolgens hardop voor. Spreek de woorden zo uit zoals je dat in je eigen dialect normaal zou uitspreken, ook als ze anders gespeld zijn dan je verwacht.
