...
new-sentence-rule-8 = Makkelijk voor te lezen
...
bulk-upload-additional-information = Als u aanvullende informatie over dit bestand wilt verstrekken, neem dan contact op met <emailFragment>wietse.de.vries@rug.nl</emailFragment>
template-file-additional-information = Als u aanvullende informatie over dit bestand wilt verstrekken die niet in de sjabloon is opgenomen, neem dan contact op met <emailFragment>wietse.de.vries@rug.nl</emailFragment>
...
bulk-submission-success-subheader = U helpt Praoten onze dagelijkse zinsdoelen te bereiken!
