...
return-to-cv = Terug naar website
email-input =
    .label = E-mailadres
loading = Laden…
email-opt-in-info = Ik wil graag e-mailberichten zoals herinneringen aan doelstellingen, mijn voortgangsupdates en nieuwsbrieven ontvangen.
email-opt-in-info-title = Gegevens delen met derden
email-opt-in-info-sub-with-challenge = Ik ga akkoord dat data met andere partijen gedeeld mogen worden nadat zij aangeven aan de voorwaarden voor datagebruik te zullen voldoen.
...
# Text wrapped in <mark></mark> will have a white background.
languages-donate-banner-cta = <mark>Gebruikt u dit project voor</mark><br/><mark>uw onderzoek?</mark>
languages-donate-banner-cta-explanation = Dit project wordt gefinancierd door donaties en subsidies! We werken graag samen met academici, onderzoekers van het maatschappelijk middenveld en de industrie. Dit platform is gratis te gebruiken, maar bijdragen aan de platform- en hostingkosten via subsidievoorstellen helpt echt.
localization-select =
    .label = Kies uw variant
