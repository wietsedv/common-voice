...
import type { Sentence as SentenceType } from "common";
...
import type StateTree from "../../../../stores/tree";
import { Uploads } from "../../../../stores/uploads";
import { User } from "../../../../stores/user";
import URLS from "../../../../urls";
import { castTrueString } from "../../../../utility";
import {
	type LocalePropsFromState,
	localeConnector,
} from "../../../locale-helpers";
...
import { CheckIcon, MicIcon, ReturnKeyIcon, StopIcon } from "../../../ui/icons";
import { Button, Spinner, TextButton } from "../../../ui/ui";
import ContributionPage, {
	type ContributionPillProps,
	SET_COUNT,
} from "../contribution";
import AudioWeb, { AudioError, type AudioInfo } from "./audio-web";
import { USER_LANGUAGES } from "./firstSubmissionCTA/firstPostSubmissionCTA";
import RecordingPill from "./recording-pill";
import type { SentenceRecording } from "./sentence-recording";
...
class SpeakPage extends React.Component<Props, State> {
	...
	render() {
		...
		const noNewClips =
			noClips || !clips.some((clip) => clip.recording === null);
